...
//  Buat nama file unik 
$nama_baru = time() . "_" . preg_replace("/[^a-zA-z0-9.]/", "_", $name_file);
$path = "../img/" . $nama_baru;
// Pindahkan file ke folder img/
if (move_uploaded_file($tmp_file, $path)) {
$sql = "INSERT INTO foto (judul_foto, deskripsi_foto, lokasi_foto, lokasi_file, tanggal_upload, id_user) 
	VALUES ('$judul_foto', '$deskripsi_foto', '$lokasi_foto', '$lokasi_file', '$tanggal_upload', '$id_user')";
...
echo "<script>alert('Gagal mengupload file ke folder img/. Pastikan folder dapat ditulis.'); histpry.back();</script>
}
