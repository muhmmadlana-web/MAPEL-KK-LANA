...
if (!isset($_SESSION['username']) || !isset($_SESSION['level_user'])) {
    header("Location: ../index.php"); // balik ke halaman login utama
    exit;
}

// cek role guest
if ($_SESSION['level_user'] !== "guest") {
    echo "Akses ditolak! Halaman ini hanya untuk guest.";
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .gallery-title { text-align: center; margin: 30px 0; color: #343a40; }
        .gallery-item {
            margin-bottom: 30px;
            overflow: hidden;
            border-radius: 10px;
        ...
        <div class="col-md-4 col-sm-6 col-12">
            <div class="gallery-item">
                ...
                <div class="image-caption">
                    ...
                    <p class="text-muted">
                        Kawasan Konservasi Mangrove dan Bekantan (KKMB) merupakan wisata alam yang terletak di dalam Kota Tarakan.<br>
                        Letaknya di Jalan Gajah Mada, persis bersebelahan dengan kompleks Pasar Gusher, salah satu pusat perekonomian di Tarakan
                    </p>
        ...
        <div class="col-md-4 col-sm-6 col-12">
            <div class="gallery-item">
                ...
                <div class="image-caption">
                    ...
                    <p class="text-muted">
                        Pantai Binalatung terletak tidak jauh dari pusat kota Tarakan.<br>
        ...
        <div class="col-md-4 col-sm-6 col-12">
            <div class="gallery-item">
                ...
                <div class="image-caption">
                    ...
                    <p class="text-muted">
                        Kabupaten Tana Tidung memiliki objek wisata hutan pinus yang menjadi jujukan wisatawan di Kalimantan Utara.<br>
                        ...
                        di Kabupaten Bulungan, tepatnya di tengah ibu kota Tana Tidung, Tideng Pale.
                    </p>
        ...
        <div class="col-md-4 col-sm-6 col-12">
            <div class="gallery-item">
                ...
                <div class="image-caption">
                    ...
                    <p class="text-muted">
                        Air Terjun Semolon berada di Kabupaten Malinau, tepatnya di Desa Paking Kecamatan Mentarang. Jaraknya sekitar 44 km<br>
                        dari Kota Malinau dan dapat diakses dengan kendaraan bermotor, dengan waktu tempuh sekitar 1,5 jam hingga 2 jam.
                    </p>
        ...
        <div class="col-md-4 col-sm-6 col-12">
            <div class="gallery-item">
                ...
                <div class="image-caption">
                    ...
                    <p class="text-muted">
                        Pantai Amal merupakan wisata pantai ikonik di Tarakan. Pantai ini memiliki luas wilayah 12,5 km persegi,<br>
                        ...
                        Aktivitas itu disebut 'tarak ngakan' dalam bahasa lokal, sehingga kemudian pulau itu dinamakan Tarakan.
                    </p>
        ...
        <div class="col-md-4 col-sm-6 col-12">
            <div class="gallery-item">
                ...
                <div class="image-caption">
                    ...
                    <p class="text-muted">
                        Tane Olen merupakan objek wisata alam yang terletak di Malinau yang cocok untuk aktivitas trekking.<br>
                        Pengunjung dapat menyusuri hutan dan sungai dengan perahu yang tersedia.<br>
                        Wisata ini pas untuk detikers yang ingin menikmati suasana alam pedalaman Kalimantan.
                    </p>
